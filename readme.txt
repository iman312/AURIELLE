============================================
  AURIELLE — Fine Jewelry E-commerce Website
  Web Development Project — L2 Informatique
============================================
...
── How to Use ──────────────────────────────
  ...
  2. No server required — all features work locally.
...
── Technologies ─────────────────────────────
  ...
  - CSS3 (custom properties, grid, flexbox, animations, responsive media queries)
  - JavaScript ES6+ (arrays, localStorage, RegEx, DOM manipulation, events)
